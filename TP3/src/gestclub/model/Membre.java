...
public class Membre implements Serializable {
	...
	public String toString() {
		switch(this.etat) {
		case Prospect:
			return nom+" "+prenom+" est un prospect depuis "+DateFR.format(dateInscription);
		case Membre:
			return nom+" "+prenom+" est un membre depuis "+DateFR.format(dateInscription);
		case Ancien:
			return nom+" "+prenom+" est n'est plus un membre depuis "+DateFR.format(dateInscription);
