...
public class Blackjack extends Application {
	...
	private IntegerProperty[] settings = {new SimpleIntegerProperty(1000), // Solde par défaut
										  ...
										  new SimpleIntegerProperty(1), // Thème
										  new SimpleIntegerProperty(50), // Volume
	...
	public void loadMusic() {
		...
		mediaPlayer.volumeProperty().bind(doubleProp);
	...
	public void start(Stage primaryStage) {
		...
		scene.getStylesheets().setAll(Blackjack.class.getResource("resource/dark.css").toExternalForm());
